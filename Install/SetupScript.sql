...
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'N', N'BEREGN: FLEX:ANDELSMESSIG&KOSTNADSSPESIFIKK:Oppdater beløp i $*HLPGRUNNLAG basertpø beløp i rad og andel i fleksifelt på kontert arbeidsordre', N'S', N'DATABASE UPDATE a SET a.amount=a.amount*b.own_funding_fx/100, a.cur_amount=a.cur_amount*b.own_funding_fx/100 FROM $*HLPGRUNNLAG a INNER JOIN afxaoegenfin b ON(b.client=a.client AND b.attribute_id=''BF'' AND b.dim_value = a.dim_5)', N'ATSEF', 40, N'B')

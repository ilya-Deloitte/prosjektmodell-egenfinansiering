...
DECLARE @userid nvarchar(10)='1100VSE';

DECLARE @grantroleaccess nvarchar(10)='ADMINM7';
DECLARE @parentmenuid nvarchar(10) = (SELECT menu_id FROM aagmenu where description='Prosjekt�konomi (BOTT)'); --denne m� eksistere i menyen!
DECLARE @module nvarchar(10)=RTRIM((SELECT module FROM aagmenu where description='Prosjekt�konomi (BOTT)'))
...
INSERT INTO agldimension (att_name, attribute_id, client, data_length, data_type,description, dim_grp, dim_position, dim_v1_txt, last_update, maintenance, period_type, rel_attr_id, related_attr, status, user_id,bflag) 
	VALUES ('EGENFIN', 'Q30',@envclient,12, 'A', 'Egenfinansiering trigges p� kostnad f�rt p� konto', 0, 'X', '', getdate(), 'M', 0, '', '', 'N', @userid,2);
...
UPDATE a SET a.rel_value='JA' 
	...
	WHERE a.client = @envclient
	AND a.attribute_id = 'A0'
	AND a.rel_attr_id = 'Q30'
	AND ( ( CAST(a.att_value AS INT) BETWEEN 3910 AND 3919 ) 
	OR ( CAST(a.att_value AS INT) BETWEEN 4000 AND 8000 ) 
	OR ( CAST(a.att_value AS INT) BETWEEN 9101 AND 9119 ) 
	OR ( CAST(a.att_value AS INT) BETWEEN 9131 AND 9138 ) 
	OR ( CAST(a.att_value AS INT) BETWEEN 9141 AND 9148 ) 
	OR a.att_value IN ('9402', '9404', '9406','9408', '9412', '9414', '9432') ) 
	AND ( ( CAST(a.att_value AS INT) NOT BETWEEN 6001 AND 6070 ))
...
DROP TABLE [dbo].[dfo_egenfinansiering]
...
INSERT INTO aagsysvalues (text1,number1,text2,number2,text3,number3,description,last_update,user_id,sys_setup_code,name,sequence_no) 
	VALUES (@envclient,0,'',0,'',0,'Firmaet benytter egenfinansieringsl�sningen for bott',getdate(),@userid,'NO','EGENFIN_TRIGGER_CLIENT',0 );

-------------------------------------
-------------------------------------
-------------------------------------
--Paste inn ag16 jobben her fra tasks-> generate scripts, eller lim inn  
-------------------------------------
-------------------------------------
-------------------------------------
...
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'C', N'STEP: Oppdater status p� uthentete rader til 1 (under_arbeid) i dfo_egenfinansiering for under arbeid', N'S', N'DATABASE UPDATE dfo_egenfinansiering SET step = 1, last_update = GETDATE() WHERE client = ''$client'' AND step = 0', N'ATSEF', 11, N'B')
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'N', N'FILTER: Luk ut rader fra HLPGRUNNLAG som ikke har delprosjekt i dim_5, plasserf�rst i hjelpetabell for � oppdatere status', N'S', N'DATABASE SELECT * INTO $*HLP01DIM5 FROM $*HLPGRUNNLAG WHERE att_5_id<>''BF''', N'ATSEF', 20, N'B')
...
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'C', N'STEP: Oppdater status til 2 (fullf�rt) i dfo_egenfinansiering for radene som bleluket ut grunnet feil verdi i dim_5', N'S', N'DATABASE UPDATE dfo_egenfinansiering SET dfo_egenfinansiering.step = 2, dfo_egenfinansiering.last_update=GETDATE() FROM $*HLP01DIM5 WHERE dfo_egenfinansiering.client = $*HLP01DIM5.client AND dfo_egenfinansiering.sequence_no = $*HLP01DIM5.sequence_no AND dfo_egenfinansiering.voucher_no = $*HLP01DIM5.voucher_no', N'ATSEF', 22, N'B')
...
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'C', N'STEP: Oppdater status til 2 (fullf�rt) i dfo_egenfinansiering for radene som bleluket ut grunnet feil prosjekttype p� prosjekt i dim_2', N'S', N'DATABASE UPDATE dfo_egenfinansiering SET dfo_egenfinansiering.step = 2,dfo_egenfinansiering.last_update=GETDATE() FROM $*HLP02TYPE WHERE dfo_egenfinansiering.client = $*HLP02TYPE.client AND dfo_egenfinansiering.sequence_no = $*HLP02TYPE.sequence_no AND dfo_egenfinansiering.voucher_no = $*HLP02TYPE.voucher_no', N'ATSEF', 32, N'B')
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'N', N'BEREGN: FLEX:ANDELSMESSIG&KOSTNADSSPESIFIKK:Oppdater bel�p i $*HLPGRUNNLAG basertp� bel�p i rad og andel i fleksifelt p� kontert arbeidsordre', N'S', N'DATABASE UPDATE a SET a.amount=a.amount*b.own_funding_fx/100, a.cur_amount=a.cur_amount*b.own_funding_fx/100 FROM $*HLPGRUNNLAG a INNER JOIN afxaoegenfin b ON(b.client=a.client AND b.attribute_id=''BF'' AND b.dim_value = a.dim_5)', N'ATSEF', 40, N'B')
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'N', N'BEREGN: FLEX:ANDELSMESSIG&KOSTNADSSPESIFIKK:Oppdater bel�p til 0 i $*HLPGRUNNLAGdersom delprosjekt mangler i fleksifelt (NULL)', N'S', N'DATABASE UPDATE a SET a.amount = 0, a.cur_amount = 0 FROM $*HLPGRUNNLAG a WHERE NOT EXISTS (SELECT 1 FROM afxaoegenfin b WHERE b.client = a.client AND b.attribute_id = ''BF'' AND b.dim_value = a.dim_5 )', N'ATSEF', 41, N'B')
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'N', N'FILTER: LUK ut rader fra HLPGRUNNLAG som har bel�p = 0', N'S', N'DATABASE SELECT b.account ,b.amount ,b.apar_id ,b.apar_type ,b.att_1_id ,b.att_2_id ,b.att_3_id ,b.att_4_id ,b.att_5_id ,b.att_6_id ,b.att_7_id ,b.client ,b.cur_amount ,b.currency ,b.dc_flag ,b.description ,b.dim_1 ,b.dim_2 ,b.dim_3 ,b.dim_4 ,b.dim_5 ,b.dim_6 ,b.dim_7 ,b.ext_arch_ref ,b.ext_inv_ref ,b.ext_ref ,b.number_1 ,b.order_id ,b.period ,b.sequence_no ,b.status ,b.tax_code ,b.tax_system ,b.trans_date ,b.value_1 ,b.value_2 ,b.value_3 ,b.voucher_date ,b.voucher_no ,b.voucher_type ,b.step INTO $*HLP03AMT0 FROM $*HLPGRUNNLAG b WHERE b.amount=0', N'ATSEF', 45, N'B')
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'N', N'FILTER: LUK ut rader fra HLPGRUNNLAG som har bel�p = 0', N'S', N'DATABASE DELETE b FROM $*HLPGRUNNLAG b WHERE b.amount=0', N'ATSEF', 46, N'B')
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'C', N'STEP: Oppdater status til 2 for utlukede rader 0-bel�p rader', N'S', N'DATABASE UPDATE dfo_egenfinansiering SET dfo_egenfinansiering.step = 2,dfo_egenfinansiering.last_update=GETDATE() FROM $*HLP03AMT0 WHERE dfo_egenfinansiering.client = $*HLP03AMT0.client AND dfo_egenfinansiering.sequence_no = $*HLP03AMT0.sequence_no AND dfo_egenfinansiering.voucher_no = $*HLP03AMT0.voucher_no', N'ATSEF', 47, N'B')
...
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'N', N'BESTILL GL07: Insert gl07 ordre i acrrepord', N'S', N'DATABASE INSERT INTO acrrepord (expire_days,user_id,invoke_time, report_name,report_id, report_type,report_cols,client,copies,order_date,server_queue,priority_no, printer,status,last_update,orderno,func_arg,description,module,func_id,mail_flag, me_mail_flag,output_id,variant) SELECT 0,''SYSTEM'',getdate(),''GL07'',''gl07'', ''B'',186,''$client'',1,getdate(),''RAPPORT'',1,''LOKAL-PRINT'',''N'',getdate(),:gl07ordernumber,''agrbibat'', ''GL07'',''BI'',88,0,0,0,2004 WHERE 1=1', N'ATSEF', 920, N'B')
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'N', N'BESTILL GL07: Insert gl07 ordre i acrparord, variant 2004 maa vaere lagt inn i UBWse setupscript', N'S', N'DATABASE INSERT INTO acrparord (client, data_length, orderno, param_id, param_name, param_val, report_name, sequence_no, text_type) SELECT ''$client'', data_length, :gl07ordernumber, param_id, title, CASE WHEN (param_id = ''batch_id'') THEN :BATCHID ELSE param_def END, report_name, sequence_no, text_type FROM aagreppardef WHERE report_name = ''GL07'' AND variant = ''2004''', N'ATSEF', 925, N'B')
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'C', N'BESTILL GL07: INSERT gl07 parameter i acrparord real_user      ''$user_id''', N'S', N'DATABASE INSERT INTO acrparord(orderno,client,report_name,param_id,sequence_no,text_type,data_length,param_name,param_val) SELECT :gl07ordernumber,''$client'',''GL07'',''real_user'' ,200,''A'',25,''Real User'' ,''$user_id'' WHERE 1=1', N'ATSEF', 930, N'B')
...
INSERT [dbo].[aagbatquery] ([commit_flag], [description], [exit_from], [query], [report_name], [sequence_no], [type]) VALUES (N'C', N'STEP: Oppdater status til 2 (fullf�rt) i dfo_egenfinansiering for radene som detble trigget egenfinansiering p�', N'S', N'DATABASE UPDATE dfo_egenfinansiering SET dfo_egenfinansiering.step=2, dfo_egenfinansiering.last_update=GETDATE() FROM $*HLPGRUNNLAG WHERE dfo_egenfinansiering.client=$*HLPGRUNNLAG.client AND dfo_egenfinansiering.sequence_no=$*HLPGRUNNLAG.sequence_no AND dfo_egenfinansiering.voucher_no=$*HLPGRUNNLAG.voucher_no', N'ATSEF', 1000, N'B')-------------------------------------
-------------------------------------
-------------------------------------
--------------------------
...
INSERT INTO aagreppardef(fixed_flag,data_length,param_id,param_def,report_name,sequence_no,text_type,title,variant,func_id,module) 
	VALUES (0,1,'tmp_save','0','ATSEF',6,'b','Save temp tables dbg',0,@funcid,@module);
...
DECLARE @variantdescription nvarchar(255) = 'Bokf�ring egenfinansiering (2004)';
...
INSERT INTO aagrepclients(client,func_id,module,report_name,variant)
VALUES (N'*',88,N'BI',N'GL07',@variant);
...
INSERT INTO aagreppardef(fixed_flag,data_length,param_id,param_def,report_name,
sequence_no,text_type,last_update,title,variant,user_id,func_id,module) 
VALUES (0,1,N'post',N'1',N'GL07',5,N'b',getdate(),N'Bokf�r',@variant,@userid,88,N'BI');
...
INSERT INTO aagreppardef(fixed_flag,data_length,param_id,param_def,report_name,
sequence_no,text_type,last_update,title,variant,user_id,func_id,module) 
VALUES (1,1,N'recalc_v2',N'0',N'GL07',20,N'b',getdate(),N'Beregn Bel�p3',@variant,@userid,88,N'BI');

INSERT INTO aagreppardef(fixed_flag,data_length,param_id,param_def,report_name,
sequence_no,text_type,last_update,title,variant,user_id,func_id,module) 
VALUES (1,1,N'recalc_v3',N'0',N'GL07',21,N'b',getdate(),N'Beregn Bel�p4',@variant,@userid,88,N'BI');

INSERT INTO aagreppardef(fixed_flag,data_length,param_id,param_def,report_name,
sequence_no,text_type,last_update,title,variant,user_id,func_id,module) 
VALUES (1,1,N'recalc_amt',N'0',N'GL07',22,N'b',getdate(),N'Beregn bel�p',@variant,@userid,88,N'BI');
...
-------------------------------------
-------------------------------------
--Paste inn triggeren her: M� kj�res separat etter scriptet ovenfor
-------------------------------------
-------------------------------------
-------------------------------------
